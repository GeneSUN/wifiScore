...
if __name__ == "__main__":
    ...
    for date_str in date_list:
        ...
        try:
            ...
            df_vmb = dfsh_all_Hsc.select( "*",F.explode("dg_model").alias("dg_model") ).dropDuplicates()\
                                    .select("serial_num","mdn","cust_id","poor_rssi","poor_phyrate","dg_model","home_score","dg_model_indiv")
            ...
            joined_df.write.parquet('/user/ZheS/wifi_score_v2/homeScore_dataframe/'+date_str)
        except Exception as e:
